                    ...
                    <div class="col-md-4">
                        <div class="order-details">
							...
							<div class="ordre-details__total bilinfo">
                                <input type="textbox" id="coupon_str" value="0" class="coupon_style mr5"/> <input type="button" name="submit" class="fv-btn coupon_style" value="Apply Coupon" onclick="set_coupon()"/>
