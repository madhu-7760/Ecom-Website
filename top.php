                                ...
                                <nav class="main__menu__nav">
                                    <ul class="main__menu">
                                        <li class="drop"><a href="#" >Brand</a>
											<?php
											$brand_res=mysqli_query($con,"select * from brand where status='1'");
											if(mysqli_num_rows($brand_res)>0){
											?>
											
											   <ul class="dropdown">
													<?php
													while($brand_rows=mysqli_fetch_assoc($brand_res)){
														?><li><a href="brandshop.php?id=<?php echo $brand_rows['id']?>"><?php echo $brand_rows['brand']?></a></li>
													<?php
													}
													?>
												</ul>
