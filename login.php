						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="POST">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="tel" name="mobile" id="mobile" placeholder="Format: 123-456-7890" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required="true" maxlength ="12" style="width:100%" >
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="password" name="password" id="password" placeholder="Your Password*" minlength="8" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" maxlength="15" style="width:100%" required>
										</div>
