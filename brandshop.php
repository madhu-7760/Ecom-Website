...
if($brand_id>0 ){
	$get_product=get_product1($con,$brand_id);
}else{
	?>
	<script>
	window.location.href='index.php';
...
<div class="body__overlay"></div>
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/5.jpeg) no-repeat scroll center center / cover ;height:500px">
